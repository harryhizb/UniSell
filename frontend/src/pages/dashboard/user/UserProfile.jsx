...
const UserProfile = () => {
  ...
  const { data: userData, refetch } = useGetUserQuery(); // Fetch user data
  ...
  useEffect(() => {
    if (user || userData) {
      setFormData({
        username:
          (user && user.username) || (userData && userData.username) || "",
        profileImage:
          ...
          <div className="bg-white p-6 rounded-lg md:w-96 max-w-xl mx-auto relative">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <input
                ...
                required
                className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm mb-4"
              />
